...
(function() {
  var callout, charm, client, color, colors, config, dgram, drawPresence, iron, messageList, msgLine, nick, parseMsg, password, port, positionForInput, presence, present, printNewMessage, randomColor, see, send, sendRaw, server, stdin, stylize;
